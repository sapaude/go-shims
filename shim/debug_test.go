...
func TestToJsonStringMap(t *testing.T) {
    var m = map[string]interface{}{
        "a": "b",
        "c": "d",
    }
    t.Logf("%s", ToJsonString(m, true))
}
...
func TestToJsonString(t *testing.T) {
    ...
    t.Log(ToJsonString(user{1, "user1", []*Fav{{"sport"}}}, true))
    t.Log(ToJsonString(&user{1, "user1", []*Fav{{"sport"}}}, false))
